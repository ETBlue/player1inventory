...
export default defineConfig({
  ...
  projects: [
    ...
    },
    {
      ...
      testMatch: ['**/item-management.spec.ts', '**/settings/tags.spec.ts', '**/settings/vendors.spec.ts', '**/settings/recipes.spec.ts', '**/cooking.spec.ts', '**/item-list-state-restore.spec.ts'],
    },
  ],
  webServer: [
    {
