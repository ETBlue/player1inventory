...
| [locations](features/locations/) | 🔲 Pending | New Location entity: per-(item×location) `ItemStock` split, global active-location switcher, location-scoped pantry/shopping/cooking, all-locations Stock-tab pager, Settings › Locations; local-first, cloud sharing deferred; 5-PR plan (entity+settings → switcher → remove family group → data-model split+scoping → Stock pager) — [brainstorming](features/locations/2026-06-11-brainstorming-locations.md) — [design](features/locations/2026-06-11-locations-design.md) — [plan](features/locations/2026-06-12-locations-plan.md) |
