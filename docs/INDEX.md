...
| [i18n](global/i18n/) | ⚠️ Partial | Core + settings/tags + shopping + cooking done; item list pages still hardcoded; log descriptions dynamic i18n 🔲 Pending — [design](global/i18n/2026-06-03-i18n-log-descriptions-design.md) — [plan](global/i18n/2026-06-03-i18n-log-descriptions-plan.md) |
