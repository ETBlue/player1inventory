...
| [refactoring](global/refactoring/) | 🔄 In Progress | Renamed all component index.tsx files to ComponentName.tsx (refactor/rename-index-tsx); LayoutInnerPages extraction — [brainstorming](global/refactoring/2026-06-04-brainstorming-layout-inner-pages.md) — [plan](global/refactoring/2026-06-04-plan-layout-inner-pages.md) 🔲 Pending |
