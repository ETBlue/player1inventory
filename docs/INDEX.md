...
| [items](features/items/) | 🔄 In Progress | Item card, form, filters, create-on-search all done; ItemCard button loading states done (`feature/button-loading-states`); explicit expirationMode field in progress (`feature/expiration-mode`); global stock settings part 1 ✅ (8 config fields `ItemStock`→`Item`, Dexie v16 + collapse rule, Info tab owns the global settings, unit-switch dialog re-hung and extended to convert every location's tracked quantities, importer accepts both shapes); part 2 (Settings assignment pages) ✅ (four assignment tabs go global: `ItemCard showStock={false}`, assigned/unassigned two-bucket ordering, catalog-only create, shelf-filter global counts, Settings pinned to the sidebar bottom) — [design](features/settings/2026-08-23-design-global-settings-pages.md) — [design](features/items/2026-08-22-design-global-stock-settings.md) — [brainstorming](features/items/2026-08-22-brainstorming-global-stock-settings.md) — issue #247; Stock tab first-keystroke bug ✅ — [bug](features/items/2026-08-23-bug-stock-tab-save-disabled.md) ; unified location-aware item search 🔲 Pending — design ✅ approved, implementation not started (`feature/unified-item-search`) — three-section search tail (in-group / in-location / global) across pantry, shelf, vendor, recipe and cart pages, closing the duplicate-`Item` hole — [design](features/items/2026-08-26-unified-item-search-design.md) — [brainstorming](features/items/2026-08-26-brainstorming-unified-item-search.md) — issue #245 |
