...
| [item-detail-tabs](features/items/) | 🔲 Pending | Locations PR #1: split Stock into its own tab, merge tags/vendors/recipes into a Relation tab w/ submenu (default vendors), add global `wikidataUrl`+`note` Item fields — [brainstorming](features/items/2026-06-11-brainstorming-item-detail-tabs.md) — [design](features/items/2026-06-11-item-detail-tabs-design.md) — [plan](features/items/2026-06-11-item-detail-tabs-plan.md) |
