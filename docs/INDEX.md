...
| [shopping](features/shopping/) | 🔄 In Progress | Cloud backend + E2E done; vendor selection in URL done; vendor carts 🔄 In Progress — [design](features/shopping/2026-06-05-vendor-carts-design.md) — [plan](features/shopping/2026-06-06-vendor-carts-plan.md) |
