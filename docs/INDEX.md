...
| [ui-polish](global/ui-polish/) | ✅ Implemented | Dialogs, toolbars, delete flows, component extraction done; RWD improvements done; form validation UX done |
...
| [onboarding](features/onboarding/) | 🔄 In Progress | Phase A done: nested tags, InfoForm refactor, dialog improvements. Phase B done: full onboarding flow (template data, 5-step route, ItemCard/VendorCard template variants, useOnboardingSetup hook, empty-data redirect, E2E). Phase C (settings reset) pending |
