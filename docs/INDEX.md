...
| [testing](global/testing/) | ⚠️ Partial | Playwright + Storybook smoke tests done; items + tags + vendors + recipes + cooking E2E (local + cloud) done; state-restore + shopping cloud E2E pending |
...
| [item-list-state-restore](features/item-list-state-restore/) | 🔲 Pending | Back-navigation state preservation done (local); cloud E2E support pending |
