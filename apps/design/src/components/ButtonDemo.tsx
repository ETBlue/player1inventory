...
const variantStyles: Record<ButtonVariant, React.CSSProperties> = {
  primary: {
    backgroundColor: 'var(--importance-primary-background)',
    borderColor: 'var(--importance-primary-background)',
    color: 'var(--foreground-colorless-inverse)',
    boxShadow: '0 1px 2px 0 rgba(0,0,0,0.05)',
  },
  secondary: {
    backgroundColor: 'var(--importance-secondary-background)',
    borderColor: 'var(--importance-secondary-background)',
    color: 'var(--foreground-colorless-inverse)',
    boxShadow: '0 1px 2px 0 rgba(0,0,0,0.05)',
  },
  destructive: {
    backgroundColor: 'var(--importance-destructive-background)',
    borderColor: 'var(--importance-destructive-background)',
    color: 'var(--foreground-colorless-inverse)',
    boxShadow: '0 1px 2px 0 rgba(0,0,0,0.05)',
  },
  neutral: {
    backgroundColor: 'var(--importance-neutral-background)',
    borderColor: 'var(--importance-neutral-background)',
    color: 'var(--foreground-colorless-inverse)',
    boxShadow: '0 1px 2px 0 rgba(0,0,0,0.05)',
  },
  'primary-outline': {
