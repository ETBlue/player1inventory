  ...
  [&_svg]:pointer-events-none [&_svg]:size-[1.2em] [&_svg]:shrink-0`,
  {
    variants: {
      variant: {
        ...
        orange: `border-tag-orange-background bg-tag-orange-background text-foreground-colorless-inverse shadow-sm hover:shadow-md`,
        brown: `border-tag-brown-background bg-tag-brown-background text-foreground-colorless-inverse shadow-sm hover:shadow-md`,
        green: `border-tag-green-background bg-tag-green-background text-foreground-colorless-inverse shadow-sm hover:shadow-md`,
        teal: `border-tag-teal-background bg-tag-teal-background text-foreground-colorless-inverse shadow-sm hover:shadow-md`,
        cyan: `border-tag-cyan-background bg-tag-cyan-background text-foreground-colorless-inverse shadow-sm hover:shadow-md`,
        blue: `border-tag-blue-background bg-tag-blue-background text-foreground-colorless-inverse shadow-sm hover:shadow-md`,
        indigo: `border-tag-indigo-background bg-tag-indigo-background text-foreground-colorless-inverse shadow-sm hover:shadow-md`,
        purple: `border-tag-purple-background bg-tag-purple-background text-foreground-colorless-inverse shadow-sm hover:shadow-md`,
        pink: `border-tag-pink-background bg-tag-pink-background text-foreground-colorless-inverse shadow-sm hover:shadow-md`,
        rose: `border-tag-rose-background bg-tag-rose-background text-foreground-colorless-inverse shadow-sm hover:shadow-md`,
