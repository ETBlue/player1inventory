...
const badgeVariants = cva(
  ...
  text-xs capitalize whitespace-nowrap`,
  {
    variants: {
      variant: {
        orange: `bg-tag-orange-background border-tag-orange-background text-foreground-colorless-inverse`,
        brown: `bg-tag-brown-background border-tag-brown-background text-foreground-colorless-inverse`,
        green: `bg-tag-green-background border-tag-green-background text-foreground-colorless-inverse`,
        teal: `bg-tag-teal-background border-tag-teal-background text-foreground-colorless-inverse`,
        cyan: `bg-tag-cyan-background border-tag-cyan-background text-foreground-colorless-inverse`,
        blue: `bg-tag-blue-background border-tag-blue-background text-foreground-colorless-inverse`,
        indigo: `bg-tag-indigo-background border-tag-indigo-background text-foreground-colorless-inverse`,
        purple: `bg-tag-purple-background border-tag-purple-background text-foreground-colorless-inverse`,
        pink: `bg-tag-pink-background border-tag-pink-background text-foreground-colorless-inverse`,
        rose: `bg-tag-rose-background border-tag-rose-background text-foreground-colorless-inverse`,

        ok: `bg-status-ok-background border-status-ok-background text-foreground-colorless-inverse`,
        warning: `bg-status-warning-background border-status-warning-background text-foreground-colorless-inverse`,
        error: `bg-status-error-background border-status-error-background text-foreground-colorless-inverse`,
        inactive: `bg-status-inactive-background border-status-inactive-background text-foreground-colorless-inverse`,
