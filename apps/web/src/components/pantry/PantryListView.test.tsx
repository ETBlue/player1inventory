...
describe('PantryListView quick update', () => {
  beforeEach(async () => {
  ...
  it('user can edit target and refill from the pantry list and have all four stock fields saved', async () => {
    // Given an item stocked in the active location with target 6 / refill 2
    const milk = await stockMilk()
    const user = userEvent.setup()
    await renderWithRouter(<PantryListView />)
  ...
  it('user can edit the due date from the pantry list when the item is in date mode', async () => {
    // Given an item in date mode with a stored due date
